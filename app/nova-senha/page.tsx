...
export default function NovaSenhaPage() {
  ...
  useEffect(() => {
    // Supabase processa automaticamente o token de recuperação da URL (detectSessionInUrl: true)
    // PASSWORD_RECOVERY dispara quando o link do email é aberto
    ...
    // Verificar se já existe sessão ativa (ex: usuário recarregou a página)
      ...
      <div className="w-full max-w-sm bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        {sucesso ? (
          <div className="text-center py-4">
            ...
            <p className="text-sm text-gray-500 mt-1">Entrando no app...</p>
          </div>
        ) : !pronto ? (
